...
export const ProfilesPage: VFC = () => {
    ...
    const createNewProfile = async () => {
        ...
        if (templates.isOk) {
            ...
            const appTemplate = templates.data.templates.find((v) => v.id === '84f870e9-9491-41a9-8837-d5a6f591f687')!;
        ...
        onOk={
            (profiles) => <DialogBody>
                ...
                <div style={{ padding: '15px', display: 'flex', minWidth: '100px', justifyContent: 'space-between', alignItems: 'center', }}>
                    <DialogButton onClick={createNewProfile} onOKButton={createNewProfile}>
