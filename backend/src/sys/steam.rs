...
// Extremely manual/hacky way to force controller profiles; here for posterity in case the current method breaks
...
//         }
//         None => {
//             // config not downloaded; find workshop or template file from
